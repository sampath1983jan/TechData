...
{
    public class DashboardPrivilege : IPrivilege
    {
        private string key;
        ...
        public PrivilegeType ComponentType { get =>  PrivilegeType.DASHBOARD; }

        public DashboardPrivilege(string clientid, string groupID,string componentID)
        {
            this.ClientID = clientid;
            this.GroupID = groupID;
            this.ComponentID = componentID;
        }
        public DashboardPrivilege(string clientid, string groupID, string componentID, string key, bool add, bool remove,
            bool edit, bool view)
        {
            this.ComponentID = componentID;
            this.GroupID = groupID;
