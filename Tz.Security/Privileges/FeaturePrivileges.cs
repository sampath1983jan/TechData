...
{
    public class FeaturePrivilege : IPrivilege
    {
        private string key;  
        private bool _add;
        ...
        public PrivilegeType ComponentType { get => PrivilegeType.FEATURE; }

        public FeaturePrivilege(string clientid, string groupID, string componentID)
        {
        ...
        public FeaturePrivilege(string clientid, string groupID, string componentID, string key, bool add, bool remove,
             bool edit, bool view)
        {
            this.ComponentID = componentID;
            this.GroupID = groupID;
