...
{
    public sealed partial class QueryScriptParser
    {
        private bool _error;
        private ErrorSink _errorSink;
        private int _index;
        private QueryScriptParserOptions _options;
        ...
        public QueryScriptParser()
            : this(new ErrorSink())
        {
        }

        public QueryScriptParser(ErrorSink errorSink)
        {
        ...
        private void InitializeParser(SourceCode sourceCode, IEnumerable<Token> tokens, QueryScriptParserOptions options)
        {
