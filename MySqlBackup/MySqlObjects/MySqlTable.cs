...
namespace MySql.Data.MySqlClient
{
    public class MySqlTable : IDisposable
    {
        ...
        public MySqlTable(MySqlCommand cmd, string name)
        {
            ...
            _createTableSql = RemoveFixedRow(_createTableSql);
        ...
        private string RemoveFixedRow(string sql)
        {
            string a = "ROW_FORMAT=FIXED";
            string b = "ROW_FORMAT=COMPRESSED";
           sql = sql.Replace(a, "");
            return sql.Replace(b, "");
        }
