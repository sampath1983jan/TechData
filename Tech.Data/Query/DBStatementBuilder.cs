...
namespace Tech.Data.Query
{
    public abstract class DBStatementBuilder: IDisposable
    {
        ...
        public virtual void GenerateCreateTableScript(Tech.Data.Schema.DBSchemaTable schemaTable)
        {
            throw new NotSupportedException("CREATE TABLE");
        }

        public virtual void GenerateCreateViewScript(Tech.Data.Schema.DBSchemaView schemaView, DBQuery script)
        {
            throw new NotSupportedException("CREATE VIEW");
        }

        public virtual void GenerateCreateProcedureScript(Tech.Data.Schema.DBSchemaSproc schemaSproc, DBScript script)
        {
            throw new NotSupportedException("CREATE PROCEDURE");
        }

        public virtual void GenerateCreateFunctionScript(Tech.Data.Schema.DBSchemaFunction schemaSproc, DBScript script)
        {
