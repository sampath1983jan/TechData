...
namespace Tech.Data.Query
{
    ...
    public abstract partial class DBQuery : DBStatement, System.Xml.Serialization.IXmlSerializable
    {
        ...
        public const string XMLSCHEMA = "http://schemas.Tech.co.uk/Query";
        ...
        {
            this.WriteXml(writer, "http://schemas.Tech.co.uk/Query", "");
        }
        ...
        {
            return DBQuery.ReadXml(reader, "http://schemas.Tech.co.uk/Query", "");
        }
