...
namespace Tech.Data.Query
{
    ...
    public abstract class DBFunction : DBClause, IDBAlias
    {
        ...
        public string FunctionName
        {
            get 
            {
                if (null == _funcname)
                {
                    if (this._func != Tech.Data.Function.Unknown)
            ...
            set 
            {
                ...
                if (string.IsNullOrEmpty(_funcname))
                    this._func = Tech.Data.Function.Unknown;
                else
                {
                    Function result;
        ...
        public static DBFunction IsNull(DBClause match, DBClause otherwise)
        {
            ...
            fref.KnownFunction = Tech.Data.Function.IsNull;
        ...
        public static DBFunction GetDate()
        {
            ...
            func.KnownFunction = Tech.Data.Function.GetDate;
        ...
        {
            DBFunction func = new DBFunctionRef();
            func.KnownFunction = Tech.Data.Function.LastID;
    ...
    internal class DBFunctionRef : DBFunction
    {
        ...
        {
            if (this.KnownFunction != Tech.Data.Function.Unknown)
