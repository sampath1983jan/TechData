    ...
    public static class DataTableExtensions
    {
        ...
        public static DataTable FindReplace(this DataTable dtResult, string ColumnName, List<KeyValuePair<string, string>> pfindReplace, string NewColumnName)
        {
            ...
            else
            {
                ...
                {
                    string rp = "[{0}] = '{1}'";
                    dtResult.Select(string.Format(rp, ColumnName, m.Key)).ToList().ForEach(x => x.SetField<string>(ColumnName, m.Value));
                }
            }
        ...
        //public static DataTable GroupBy(this DataTable dtResult,string[] AggregateColumn, GroupAggregate ga) {
        ...
        //    var dailyQuery =
        //               from dailyRow in dtResult.AsEnumerable()
        //               group dailyRow by new
        //               {
        //                   date = dailyRow.Field<DateTime>("date")
        //               }
        //                   into dailyGroup
        //                   select dtResult.LoadDataRow(new object[]
        //                        {
        //                            dailyGroup.Key.date,                                     
        //                            dailyGroup.Sum(newDailyRow => newDailyRow.Field<int>("total_records")),
        //                            dailyGroup.Sum(newDailyRow => newDailyRow.Field<int>("minutes_gained"))
        //                        }, false);
