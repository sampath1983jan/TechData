...
namespace Tech.QScript.Syntax
{
    ...
    public class QueryDefination {
        ...
        public static string tablefield = @"\w*?:\w*";
    ...
    public class SQuery:SyntaxNode  ,Element
    {
        ...
        {
            var tbl = this.tables.Where(x => x.TableName == tbName || x.TableAlias == tbName).ToList();
            ...
            {
                this.tables.Add(new Table() { TableName = tbName, TableAlias = tbName }
