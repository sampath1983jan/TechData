...
namespace Tech.Data
{
    ...
    //
    // callback methods for the DBDataBase.ExecuteReader method
    //

    /// <summary>
    /// one of 3 callback method signatures from the DBDatabase.ExecuteReader(...) methods.
    /// </summary>
    /// <param name="reader">The reader created by the DBDatabase from the statement</param>
    /// <returns>Returns any object the the caller of the ExecuteReader statement requires.</returns>
    ...
    /// <summary>
    /// one of 3 callback methods signatures for the DBDatabase.ExecuteReader(...) methods. This signature supports the passing of a context object.
    /// </summary>
    /// <param name="reader">The reader created by the DBDatabase from the statement passed to ExecuteReader...</param>
    /// <param name="context">Any context required by the delegate method</param>
    /// <returns>Returns any object the call of the ExecuteReader statement requires.</returns>
    ...
    /// <summary>
    /// One of 3 callback methods for the DBDatabase.ExecuteReader(...) methods. This signature does not return a value so no value is required to be returned
    /// </summary>
    /// <param name="reader">The reader created by the DBDatabase from the statement passed to ExecuteReader(..</param>
