...
{
    /// <summary>
    /// The Tech.Data.DynaSQL library is a Data Access Layer and dynamic query generator that dramatically reduces the boiler plate code,
    ...
    ///                      
    ///       northwind.ExecuteReader(sel,delegate(DBDataReader reader){ //do your read here 
    ///                         });
    /// </code>
    /// <para>Want to run dynamic sql queries? Use the <see cref="Tech.Data.Query"/> namespace for the <see cref="Tech.Data.Query.DBQuery"/> class.</para>
    /// </remarks>
...
{
    /// <summary>
    /// The Tech.Data.Query namespace conatins the classes used to build the dynamic SQL statements that can be executed against 
    /// any of the supported database providers.
    /// </summary>
    /// <remarks>The <see cref="Tech.Data.Query.DBQuery" /> class has the static methods that 
    ...
    ///                      .Where("myfield",Compare.Equals,DBConst(1));
    /// </code>
    /// <para>This select query can now be executed against the <see cref="Tech.Data.DBDatabase"/> instance</para>
    /// </remarks>
    internal static class NamespaceDoc
    {
    }
...
namespace Tech.Data.Profile
{
    /// <summary>
    /// The Tech.Data.Profile namespace contains the classes that enable profiling of the 
...
namespace Tech.Data.Schema
{
    ...
    /// <summary>
    /// The Tech.Data.Schema namespace enables the extraction and analysis of a database schema at runtime. 
...
namespace Tech.Data.Configuration
{
    /// <summary>
...
namespace Tech.Data.MySqlClient
{
    /// <summary>
