...
(function (global, factory) {
    (typeof exports === "undefined" ? "undefined" : _typeof(exports)) === 'object' && typeof module !== 'undefined' ? module.exports = factory() : typeof define === 'function' && define.amd ? define(factory) : (global = global || self, global.VueRouter = factory());
})(void 0, function () {
    'use strict';
    /*  */
    ...
    function isExtendedError(constructor, err) {
        return _instanceof(err, constructor) || // _name is to support IE9 too
    ...
    VueRouter.prototype.init = function init(app
        ...
        if (_instanceof(history, HTML5History)) {
            history.transitionTo(history.getCurrentLocation());
        } else if (_instanceof(history, HashHistory)) {
