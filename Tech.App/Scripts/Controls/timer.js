...
(function ($) {
    ...
    $.fn.timepicki = function (options) {
        ...
        var methods = {
            setValue: function (a1,a2,a3) {
                ...
                if (a1 instanceof Array) {
                    ...
                    if (tim.length !== 0 && mini.length !== 0 && (!s.show_meridian || meri.length !== 0)) {
            ...
            getValue: function () {
                ...
                if (val !== "") {
                    ...
                    if (s.show_meridian) {
                        ...
                        if (meri.toLocaleLowerCase() === 'pm' && tim < 12) {
                            tim += 12;
                        }
                        else if (meri.toLocaleLowerCase() === 'am' && tim == 12) {
                            tim -= 12;
                        }
                    }
                    var td = new Date();
                    var o = {
                        ...
                        m: mini,
                        mr: meri,
                        date: new Date(td.getFullYear(), td.getMonth(), td.getDay(), tim, mini)
                    };
                    return o;
                }  
        ...
        if (methods[options] && options.charAt(0) !== '_') {
            var arg = arguments;
          //  return this.each(
               // function () {
                  return  methods[options].apply(this, Array.prototype.slice.call(arg, 1));
        ...
        return this.each(function () {
            ...
            var top_arrow_button = (settings.increase_direction === 'down') ?
                "<div class='prev action-prev'><span class='fa fa-angle-up' style='font-weight:bold'></span></div>" :
                "<div class='prev action-next'><span class='fa fa-angle-down' style='font-weight:bold'></span></div>";
            var bottom_arrow_button = (settings.increase_direction === 'down') ?
                "<div class='next action-next'><span class='fa fa-angle-down' style='font-weight:bold'></span></div>" :
                "<div class='next action-prev'><span class='fa fa-angle-up' style='font-weight:bold'></divspandiv>";
            ...
            function set_value(event, close) {
                ...
                methods.setValue.apply(ele, [tim, mini, meri]);
